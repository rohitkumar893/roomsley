...
const handleSubmit = async (e) => {
  ...
  try{
    ...
    const response = await fetch("https://roomsleybackendrender.onrender.com/api/api/auth/listings", {
      method:"POST",
      body:formData,
  })
  ...
  const toggleModal = () => {
    ...
    try {
          ...
          const response = await fetch(
            "https://roomsleybackendrender.onrender.com/api/api/auth/listings", 
            {
              method: "GET"
            }
          );
      ...
      const deleteList = async (listing) => {
        try {
          const response = await fetch(
            `https://roomsleybackendrender.onrender.com/api/api/auth/listings/${listing._id}`,
            { method: "DELETE" }
          );
