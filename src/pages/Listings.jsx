...
const handleSubmit = async (e) => {
  ...
  try{
    ...
    const response = await fetch("https://roomsleybackend-production.up.railway.app/api/auth/listings", {
      method:"POST",
      body:formData,
  })
  ...
  const toggleModal = () => {
    ...
    const fetchListings = async () => {
      try {
        setLoading(true);
        const response = await fetch("https://roomsleybackend-production.up.railway.app/api/auth/getlistings", {
          method: "POST",
          headers: {
      ...
      const deleteList = async (listing) => {
        const response = await fetch("https://roomsleybackend-production.up.railway.app/api/auth/deletelisting",{
          method:"POST",
          headers:{
            "Content-Type":"application/json"
          },
