...
function App() {
  ...
  return (
    <>
      ...
      <nav className="h-[68px] w-full flex justify-start items-center gap-[8px] bg-gray-800 text-[22px]">
        ...
        <div className='landingcontainer h-[100%] w-[100%] flex flex-col sm:flex-row justify-center items-center'>
          ...
          <div className='marginctrl flex flex-col md:flex-row h-full w-full justify-between gap-[30px]'>
              ...
              <div>
                <img src='roomimg.jpg' className='roomimg object-cover h-[580px] sm:h-[650px] w-[600px] z-[-1] relative top-[0px] rounded-sm shadow-md'></img>
              </div>
             </div>
          </div>
        </div>
      ...
      <div className='footer relative bottom-0 h-[35px] w-full flex justify-center items-center text-gray-600 font-medium' style={{ backgroundColor:"white" }}>
          <h5>Roomsley · 2025</h5>
      </div>
    </>
  );
