          ...
          <div className='padder h-[100%] w-[100%]'>
            <div className='marginctrl flex flex-col md:flex-row h-full w-full justify-between gap-[45px]'>
              <div className='flex flex-col gap-[30px]'>
                  ...
                  <h2 className='text-[18px] sm:w-[410px] w-[360px] font-normal text-gray-700'> Finding a place or offering one? <br /> Roomsley makes it simple and quick.</h2>
                  <Link to="/listings">
              ...
              <div>
                <img src='roomimg.jpg' className='roomimg h-[445px] w-[580px] md:h-[400px] md:w-[500px] sm:h-[600px] sm:w-[600px] rounded-md'></img>
              </div>
             </div>
          </div>
        </div>
